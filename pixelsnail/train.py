...
from model import PixelSNAIL, discretized_logistic_mix_loss
...
parser.add_argument('-n', '--n_res', type=int, default=4, help='Number of res blocks per attentive step')
parser.add_argument('-a', '--attn_rep', type=int, default=10, help='Number of attentive steps')
...
log_dir = os.path.join('.', 'logs', 'pixelsnail', time)
